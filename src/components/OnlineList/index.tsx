...
import { handleDislikeMusic, handleDownloadMv, handlePlay, handlePlayLater, handlePlayMv, handleShare, handleShowMusicSourceDetail } from './listAction'
  ...
  return (
    <View style={styles.container}>
      ...
      <ListMenu
        ...
        onPlayMv={info => { void handlePlayMv(info.musicInfo) }}
        onDownloadMv={info => { handleDownloadMv(info.musicInfo) }}
      />
