const modules = {
  ...
  winMain: {
    ...
    import_user_api_group: 'import_user_api_group',
    remove_user_api_group: 'remove_user_api_group',
    get_user_api_group_list: 'get_user_api_group_list',
    user_api_group_updated: 'user_api_group_updated',
    ...
    download_mv: 'download_mv',
    download_mv_progress: 'download_mv_progress',
  },
  winLyric: {
    close: 'close',
    set_config: 'set_config',
...
export const WIN_MV_RENDERER_EVENT_NAME = modules.winMv
