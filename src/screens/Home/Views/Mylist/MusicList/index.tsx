...
import { handleDownloadMv, handlePlayMv } from '@/components/OnlineList/listAction'
  ...
  return (
    <View style={styles.container}>
      ...
      <ListMenu
        ...
        onPlayMv={info => { void handlePlayMv(info.musicInfo as LX.Music.MusicInfoOnline) }}
        onDownloadMv={info => { handleDownloadMv(info.musicInfo as LX.Music.MusicInfoOnline) }}
      />
