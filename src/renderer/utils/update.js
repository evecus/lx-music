...
const address = [
  [`https://raw.githubusercontent.com/${REPO_OWNER}/${REPO_NAME}/desktop/publish/version.json`, 'direct'],
  [`https://cdn.jsdelivr.net/gh/${REPO_OWNER}/${REPO_NAME}@desktop/publish/version.json`, 'direct'],
  [`https://fastly.jsdelivr.net/gh/${REPO_OWNER}/${REPO_NAME}@desktop/publish/version.json`, 'direct'],
  [`https://gcore.jsdelivr.net/gh/${REPO_OWNER}/${REPO_NAME}@desktop/publish/version.json`, 'direct'],
]
